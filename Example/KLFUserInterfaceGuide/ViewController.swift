...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.presentUserInterfaceGuide(view: self.subView, message: "This is very beginning message!!!", dismissWhenTapedOutside: true) {
            print()
        }
        self.presentUserInterfaceGuide(view: self.innerSubview, message: "This is another message!!!")
        self.presentUserInterfaceGuide(view: subView, message: "This is very beginning message!!!", dismissWhenTapedOutside: false, decision: { point in
